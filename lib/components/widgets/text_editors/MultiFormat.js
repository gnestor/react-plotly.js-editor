...
var MultiFormatTextEditor = function (_Component) {
  ...
  function MultiFormatTextEditor(props) {
    _classCallCheck(this, MultiFormatTextEditor);

    var _this = _possibleConstructorReturn(this, (MultiFormatTextEditor.__proto__ || Object.getPrototypeOf(MultiFormatTextEditor)).call(this, props));
...
exports.default = (0, _localize2.default)(MultiFormatTextEditor);
