  ...
  _createClass(PanelsWithSidebar, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: (0, _lib.bem)('plotly-editor', 'wrapper') },
        ...
        _react2.default.Children.map(this.props.children, function (child, i) {
          return _this2.state.group !== child.props.group || _this2.state.panel !== child.props.name ? null : (0, _react.cloneElement)(child, { key: i });
        })
      );
    }
  }]);
